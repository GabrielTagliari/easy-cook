...
import com.easycook.easycook.fragment.dummy.DummyContent.DummyItem;
...
public class CompraRecyclerViewAdapter extends RecyclerView.Adapter<CompraRecyclerViewAdapter.ViewHolder> {
    ...
    public CompraRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
